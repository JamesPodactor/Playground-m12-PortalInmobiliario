...
},{"./property-detail.api":"675is","./property-detail.mappers":"fd7bK","../../core/router/history":"7E2Mc","./property-detail.helpers":"fj9W2"}],"675is":[function(require,module,exports) {
...
const getProperty = (id)=>(0, _axiosDefault.default).get(url, {
        params: {
            id: id
        }
    }).then(({ data  })=>data);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fd7bK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eJXPq","aoGpU"], "aoGpU", "parcelRequire4bdb")
